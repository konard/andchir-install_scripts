...
- Если необходимо создать базу данных для какого-то одного ПО, никогда не используй root пароль и пользователя, создай нового пользователя и новый паролль, если его ещё нет.
