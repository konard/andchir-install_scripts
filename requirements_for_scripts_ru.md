...
- Если необходимо создать базу данных для какого-то одного ПО, никогда не используй root пароль и пользователя, создай ного пользователя и новый паролль, если его ещё нет.
